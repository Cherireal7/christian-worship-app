...
import { getConfessionById } from '../../constants/confessions';
    ...
    return (
      <SafeAreaView edges={['top', 'left', 'right', 'bottom']} style={[styles.safeArea, { backgroundColor: theme.background }]}>
        <View style={styles.missingWrap}>
          <Text style={[styles.missingTitle, { color: theme.text }]}>ጽሑፉ አልተገኘም</Text>
          <Pressable
      ...
      <View style={[styles.screen, { backgroundColor: theme.background }]}>
        <ScrollView contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.readerCard, { backgroundColor: theme.surfaceStrong, borderColor: theme.border }]}>
            <Text style={[styles.readerTitle, { color: theme.text, fontSize: 24 * appFontScale, lineHeight: 34 * appFontScale }]}>{confession.title}</Text>
            <Text style={[styles.readerSubtitle, { color: theme.textMuted, fontSize: 14 * appFontScale }]}>{confession.subtitle}</Text>
            <Text
              style={[
                styles.bodyText,
                {
